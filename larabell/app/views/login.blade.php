...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link href="/packages/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
  ...
  <body class="login-page">
    ...
    <!-- iCheck -->
    <script src="/packages/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
    <script>
      $(function () {
        $('input').iCheck({
